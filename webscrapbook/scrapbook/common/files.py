...
class Files:
    ...
    def __set_file_constants(self):
        ...
        self.__constants.TOC_NAME_TEMPLATE      = str("toc{}.js")
        self.__constants.META_NAME_TEMPLATE     = str("meta{}.js")
        self.__constants.FULLTEXT_NAME_TEMPLATE = str("fulltext{}.js")
    ...
    def write_toc(self):
        def toc_preprocessing(string):
                return self.__constants.TOC_COMMENT + self.__constants.TOC_PREFIX + string + self.__constants.TOC_SUFFIX
        ...
        self.__write_split_files(
            self.files.toc,
            max_size,
            self.__constants.TOC_NAME_TEMPLATE,
            toc_preprocessing
        )

    def write_meta(self):
        def meta_preprocessing(string):
                return self.__constants.META_COMMENT + self.__constants.META_PREFIX + string + self.__constants.META_SUFFIX
        ...
        self.__write_split_files(
            self.files.meta,
            max_size,
            self.__constants.META_NAME_TEMPLATE,
            meta_preprocessing
        )
