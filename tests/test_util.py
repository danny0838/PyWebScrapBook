...
"""
    ...
    def test_zip_has(self):
        ...
        self.assertFalse(util.zip_has(zip_filename, 'file.txt/', type='dir'))
        self.assertTrue(util.zip_has(zip_filename, 'explicit_folder', type='dir'))
        self.assertTrue(util.zip_has(zip_filename, 'explicit_folder/', type='dir'))
        ...
        self.assertFalse(util.zip_has(zip_filename, 'nonexist/', type='dir'))

        self.assertFalse(util.zip_has(zip_filename, '', type='file'))
        self.assertFalse(util.zip_has(zip_filename, '/', type='file'))
        self.assertTrue(util.zip_has(zip_filename, 'file.txt', type='file'))
        self.assertTrue(util.zip_has(zip_filename, 'file.txt/', type='file'))
        self.assertFalse(util.zip_has(zip_filename, 'explicit_folder', type='file'))
        self.assertFalse(util.zip_has(zip_filename, 'explicit_folder/', type='file'))
        ...
        self.assertFalse(util.zip_has(zip_filename, 'nonexist/', type='file'))

        self.assertTrue(util.zip_has(zip_filename, '', type='any'))
        self.assertTrue(util.zip_has(zip_filename, '/', type='any'))
        self.assertTrue(util.zip_has(zip_filename, 'file.txt', type='any'))
        self.assertTrue(util.zip_has(zip_filename, 'file.txt/', type='any'))
        self.assertTrue(util.zip_has(zip_filename, 'explicit_folder', type='any'))
        self.assertTrue(util.zip_has(zip_filename, 'explicit_folder/', type='any'))
        ...
        self.assertFalse(util.zip_has(zip_filename, 'nonexist/', type='any'))
